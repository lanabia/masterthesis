...
\begin{document}
	...
	\input{2-textuais/5-guidelines}
	\input{2-textuais/6-conclusao}
	
	\input{2-textuais/atalhos-overleaf}
	

	%Elementos pós-textuais	
	\bibliography{3-pos-textuais/reference-mendeley}
	%\imprimirglossario	
	\imprimirapendices
		...
		\input{3-pos-textuais/apendices/apendice-guidelines.tex}
	%\imprimiranexos
