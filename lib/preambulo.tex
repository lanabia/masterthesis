...
\usepackage{amsgen}
\usepackage{lipsum}                                 % Usar a simulação de texto Lourrem Ipsum
...
\usepackage[alf, abnt-emphasize=bf, recuo=0cm, abnt-etal-cite=2, abnt-etal-list=0, abnt-etal-text=it,abnt-and-type=&, abnt-url-package=none]{abntex2cite}  % Citações padrão ABNT
