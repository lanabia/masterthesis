...
This appendix shows an infographic of the guidelines presented, also available at  \url{https://www.dropbox.com/s/38sjwqc2et73oau/guidelines_infographic.png?dl=0}.
 	...
 	\begin{figure}[h] 
		...
		\Caption{\label{fig:guidelines1} Guidelines infographic (part 1).}
		\UFCfig{}{
	...
	\end{figure}
 	...
 	\begin{figure}[h] 
   	    \captionsetup{width=16cm}%Da mesma largura que a figura
		\Caption{\label{fig:guidelines2} Guidelines infographic (part 2).}
		\UFCfig{}{
	...
	\end{figure}
 	...
 	\begin{figure}[h] 
   	    \captionsetup{width=16cm}%Da mesma largura que a figura
		\Caption{\label{fig:guidelines3} Guidelines infographic (part 3).}
		\UFCfig{}{
